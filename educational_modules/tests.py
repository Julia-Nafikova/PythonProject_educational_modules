...
class EducationalModuleTestCase(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.lesson = Lesson.objects.create(name="Урок 1", description="Что-то про урок",
                                            video_link="https://www.youtube.com/lesson1/",
                                            owner=self.user)

    def test_lesson_detail(self):
        url = reverse("educational_modules:lesson", args=(self.lesson.pk,))
    ...
    def test_lesson_update(self):
        url = reverse("educational_modules:update_lesson", args=(self.lesson.pk,))
    ...
    def test_lesson_delete(self):
        url = reverse("educational_modules:delete_lesson", args=(self.lesson.pk,))
